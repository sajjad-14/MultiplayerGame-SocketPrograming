...
def clicked1():
    ...
    if start and user and btn1["text"]==" ":   #For getting the text of a button
        if board.lastMove == player2:
            ...
            sendData = '{}-{};{}'.format("0",board.lastMove, time.time()).encode()
            clientSocket.send(sendData)
...
def clicked2():
    ...
    if start and user and btn2["text"]==" ":   #For getting the text of a button
        if board.lastMove == player2:
            btn2["text"]="O"
            board.lastMove = "player1"
            sendData = '{}-{};{}'.format("1",board.lastMove, time.time()).encode()
            clientSocket.send(sendData)
...
def clicked3():
    ...
    if start and user and btn3["text"]==" ":   #For getting the text of a button
        if board.lastMove == player2:
            btn3["text"]="O"
            board.lastMove = "player1"
            sendData = '{}-{};{}'.format("2",board.lastMove, time.time()).encode()
            clientSocket.send(sendData)
...
def clicked4():
    ...
    if start and user and btn4["text"]==" ":   #For getting the text of a button
        if board.lastMove == player2:
            btn4["text"]="O"
            board.lastMove = "player1"
            sendData = '{}-{};{}'.format("3",board.lastMove, time.time()).encode()
            clientSocket.send(sendData)
...
def clicked5():
    ...
    if start and user and btn5["text"]==" ":   #For getting the text of a button
        if board.lastMove == player2:
            btn5["text"]="O"
            board.lastMove = "player1"
            sendData = '{}-{};{}'.format("4",board.lastMove, time.time()).encode()
            clientSocket.send(sendData)
...
def clicked6():
    ...
    if start and user and btn6["text"]==" ":   #For getting the text of a button
        if board.lastMove == player2:
            btn6["text"]="O"
            board.lastMove = "player1"
            sendData = '{}-{};{}'.format("5",board.lastMove, time.time()).encode()
            clientSocket.send(sendData)
...
def clicked7():
    ...
    if start and user and btn7["text"]==" ":   #For getting the text of a button
        if board.lastMove == player2:
            btn7["text"]="O"
            board.lastMove = "player1"
            sendData = '{}-{};{}'.format("6",board.lastMove, time.time()).encode()
            clientSocket.send(sendData)
...
def clicked8():
    ...
    if start and user and btn8["text"]==" ":   #For getting the text of a button
        if board.lastMove == player2:
            btn8["text"]="O"
            board.lastMove = "player1"
            sendData = '{}-{};{}'.format("7",board.lastMove, time.time()).encode()
            clientSocket.send(sendData)
...
def clicked9():
    ...
    if start and user and btn9["text"]==" ":   #For getting the text of a button
        if board.lastMove == player2:
            btn9["text"]="O"
            board.lastMove = "player1"
            sendData = '{}-{};{}'.format("8",board.lastMove, time.time()).encode()
            clientSocket.send(sendData)
